  ...
  <div className="container">
    <div className="footer-grid">
      <div className="footer-col footer-brand-block">
        <div className="footer-logo"><img src="/logo.svg" alt="WAGS Tech Logo" style={{ width: '38px', height: '38px', objectFit: 'contain' }} /><div><div className="footer-brand-name">WAGS Tech EST.</div><div className="footer-brand-tag">Odoo ERP & IT Solutions · KSA</div></div></div>
        <p className="footer-brand-desc">Empowering Saudi businesses with tailored Odoo ERP solutions, ZATCA-compliant from day one.</p>
        <div className="footer-social">
          ...
          <a href="#" aria-label="WhatsApp"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51l-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347M12.05 22h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374A9.86 9.86 0 0 1 2.16 12C2.161 6.55 6.596 2.116 12.048 2.116c2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884"/></svg></a>
        </div>
      </div>
      <div className="footer-col"><h5>Solutions</h5><a href="#services">Odoo ERP</a><a href="#services">POS Integration</a><a href="#services">ZATCA Compliance</a><a href="#services">Custom Modules</a></div>
      <div className="footer-col"><h5>Company</h5><a href="#about">About</a><a href="#team">Team</a><a href="#clients">Clients</a><a href="#contact">Contact</a></div>
      <div className="footer-col"><h5>Contact</h5><p>info@wags.sa</p><p>Taawun Area, Riyadh</p><p>Saudi Arabia</p></div>
    </div>
    <div className="footer-bottom">
      <div className="footer-copy">© 2025 WAGS Tech EST. All rights reserved.</div>
